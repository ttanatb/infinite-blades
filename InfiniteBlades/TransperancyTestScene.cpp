...
// --------------------------------------------------------
TransperancyTestScene::TransperancyTestScene(HINSTANCE hInstance)
...
// --------------------------------------------------------
TransperancyTestScene::~TransperancyTestScene()
{
...
// --------------------------------------------------------
void TransperancyTestScene::Init()
{
	LoadShaderMeshMat();
	CreateEntities();
...
// --------------------------------------------------------
void TransperancyTestScene::LoadShaderMeshMat()
{
	//shaders
	...
	matMngr->AddMat("ice", vShader, pShader, L"Assets/Textures/ice.jpg", nullptr, true, .85f);
...
void TransperancyTestScene::CreateEntities()
{
	//create camera
...
void TransperancyTestScene::InitInput()
{
...
// --------------------------------------------------------
void TransperancyTestScene::OnResize()
{
...
// --------------------------------------------------------
void TransperancyTestScene::Update(float deltaTime, float totalTime)
{
	inputMngr->Update();
...
// --------------------------------------------------------
void TransperancyTestScene::Draw(float deltaTime, float totalTime)
{
...
// --------------------------------------------------------
void TransperancyTestScene::OnMouseDown(WPARAM buttonState, int x, int y)
{
...
// --------------------------------------------------------
void TransperancyTestScene::OnMouseUp(WPARAM buttonState, int x, int y)
{
	// Add any custom code here...
...
// --------------------------------------------------------
void TransperancyTestScene::OnMouseMove(WPARAM buttonState, int x, int y)
{
	// Add any custom code here...
...
// --------------------------------------------------------
void TransperancyTestScene::OnMouseWheel(float wheelDelta, int x, int y)
{
	// Add any custom code here...
}
#pragma endregion