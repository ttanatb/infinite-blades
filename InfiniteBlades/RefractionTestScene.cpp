...
// --------------------------------------------------------
RefractionTestScene::RefractionTestScene(HINSTANCE hInstance)
...
void RefractionTestScene::AddEntityToRender()
{
...
// --------------------------------------------------------
void RefractionTestScene::LoadShaderMeshMat()
{
	//shaders
...
void RefractionTestScene::InitInput()
{
...
// --------------------------------------------------------
void RefractionTestScene::OnResize()
{
...
// --------------------------------------------------------
void RefractionTestScene::Update(float deltaTime, float totalTime)
{
	inputMngr->Update();
...
// --------------------------------------------------------
void RefractionTestScene::Draw(float deltaTime, float totalTime)
{
...
// --------------------------------------------------------
void RefractionTestScene::OnMouseDown(WPARAM buttonState, int x, int y)
{
...
// --------------------------------------------------------
void RefractionTestScene::OnMouseUp(WPARAM buttonState, int x, int y)
{
	// Add any custom code here...
...
// --------------------------------------------------------
void RefractionTestScene::OnMouseMove(WPARAM buttonState, int x, int y)
{
	// Add any custom code here...
...
// --------------------------------------------------------
void RefractionTestScene::OnMouseWheel(float wheelDelta, int x, int y)
{
	// Add any custom code here...
}
#pragma endregion