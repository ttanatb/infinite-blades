...
// --------------------------------------------------------
CoinTestScene::CoinTestScene(HINSTANCE hInstance)
...
void CoinTestScene::AddEntityToRender()
{
...
// --------------------------------------------------------
void CoinTestScene::LoadShaderMeshMat()
{
	//shaders
...
void CoinTestScene::CreateEntities()
{
	//create camera
...
// --------------------------------------------------------
void CoinTestScene::Update(float deltaTime, float totalTime)
{
	inputMngr->Update();
...
// --------------------------------------------------------
void CoinTestScene::Draw(float deltaTime, float totalTime)
{
...
// --------------------------------------------------------
void CoinTestScene::OnMouseDown(WPARAM buttonState, int x, int y)
{
...
// --------------------------------------------------------
void CoinTestScene::OnMouseUp(WPARAM buttonState, int x, int y)
{
	// Add any custom code here...
...
// --------------------------------------------------------
void CoinTestScene::OnMouseMove(WPARAM buttonState, int x, int y)
{
	// Add any custom code here...
...
// --------------------------------------------------------
void CoinTestScene::OnMouseWheel(float wheelDelta, int x, int y)
{
	// Add any custom code here...
}
#pragma endregion